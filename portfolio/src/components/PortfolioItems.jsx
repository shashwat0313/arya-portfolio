            ...
            <ol className="custom-ol-list text-2xl">
                <li className="font-piazzolla ">Soft Articles for College Newsletter
                    ...
                    <ol className="custom-ol-list">
                        <li className="text-xl"><Link to={`${BASE_URL}/works/${traderelations}`} className="underline"><SmallText text="How Trade Relations Play A Role In Ensuring International Peace" /></Link></li>
                        <li className="text-xl"><Link to={`${BASE_URL}/works/${outerspace}`} className="underline"><SmallText text="Outer Space, Stories, and Pop Culture" /></Link> </li>
                        <li className="text-xl"><Link to={`${BASE_URL}/works/${mythology}`} className="underline"> <SmallText text="Are Different Interpretations of Mythology Valid?" /></Link></li>
                    </ol>
                </li>
                <li className="font-piazzolla">Authored Article (for internship)
                    ...
                    <ul className="custom-list ml-8">
                        <li className="text-xl"> <Link to={`${BASE_URL}/works/${internship}`} className="underline"> <SmallText text="Text" /> </Link> </li>
                ...
                <li className="font-piazzolla">Hard News Articles for College Newsletter
                    <p></p>
                    <ol className="custom-ol-list">
                        <li className="text-xl"> <Link to={`${BASE_URL}/works/${titansub}`} className="underline"> <SmallText text="The Titan Sub Fiasco: All You Need To Know" /> </Link> </li>
                        <li className="text-xl"> <Link to={`${BASE_URL}/works/${blrheatwave}`} className="underline">  <SmallText text="Bengaluru Heatwave" /> </Link> </li>
                    </ol>
                </li>
                <li className="font-piazzolla">Poems
                    <p></p>
                    <ol className="custom-ol-list">
                        <li className="text-xl"><Link to={`${BASE_URL}/works/${myopia}`} className="underline"><SmallText text="Myopia" /></Link></li>
                        <li className="text-xl"><Link to={`${BASE_URL}/works/${artlimitations}`} className="underline"><SmallText text="Limitations on Art" /></Link></li>
                    </ol>
                </li>
            </ol>
        </div>
